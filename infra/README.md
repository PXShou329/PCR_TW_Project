# RP-B5-1 local/private deployment
...
`AUTO_PUBLISH=true` or `SHADOW_MODE=false`; the scheduler rejects both in RP-B5-1.
...
The current image carries the immutable RP-B5-1 manifest plus RP-A2／RP-A3／RP-A4／RP-A5
