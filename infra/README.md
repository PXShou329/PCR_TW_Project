...
`AUTO_PUBLISH=true` or `SHADOW_MODE=false`; the scheduler rejects both in B1.
See `docs/operations/B1_RUNBOOK.md` for full-core round-trip, verification,
backup restore and atomic rollback.
