...
`AUTO_PUBLISH=true` or `SHADOW_MODE=false`; the scheduler rejects both in A4.
...
For the exact RP-A4 to RP-A3 deployment order, pinned-source contract and
