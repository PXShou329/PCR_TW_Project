...
本輪另需補查（依 02 OPEN_GAPS SSOT）：2026/08/09 後台服主線／深域／專1／專2／六星與台日新卡池公告；候選 #4 深域第10區的 JP 側官方化（TW 側已由 ev029 完成）；日服 8.5 周年直播只在實際開啟官方正文或影片精確段落後才可引用內容；2–4 個新錨點、1–2 筆排程調整案例。無法直頁回驗者維持 PENDING_REVIEW。ev045／ev046／ev047／ev049／#3943 已於 2026-08-09 實開正文，不得再列為待回驗。
```
